...
def data_receipt(send_from, always_send_to, login_email, dtype, region, estuaryclass, mpastatus, estuarytype, estuaryname, projectid, year, originalfile, eng, mailserver, *args, **kwargs):
    """
    ...
    email_body += f"Requester: {login_email}\n"
